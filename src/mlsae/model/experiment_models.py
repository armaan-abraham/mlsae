...
class ActInflationSAE(ExperimentSAEBase):
    ...
    def _forward(self, x, iteration=None):
        ...
        eps = 1e-9
        mean_acts_recip = (mean_acts_per_feature + eps) ** -1
        
        act_inflation_loss = mean_acts_recip.mean() * self.act_inflate
...
class ExperimentSAETop8InflateRecipNeg8(ActInflationSAE):
