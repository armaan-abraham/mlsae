...
class DataConfig:
    ...
    def act_block_size_entries(self) -> int:
        return self.act_block_size_tokens * (self.act_size // self.act_size_divisor)
    
    @property
    def reduced_act_size(self) -> int:
        return self.act_size // self.act_size_divisor
...
assert data_cfg.act_size % data_cfg.act_size_divisor == 0
